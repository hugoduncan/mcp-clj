...
(deftest test-transport-creation
  (testing "Test transport provider creation"
...
(deftest ^:integ test-data-marshalling
  (testing "Test data conversion between Clojure and Java"
...
(deftest ^:integ test-tool-execution-patterns
  (testing "Client tool execution with"
...
(deftest ^:integ test-error-handling
  (testing "Test error handling for"
